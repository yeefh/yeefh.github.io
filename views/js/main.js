...
// This function was moved from inside resizePizzas
...
function determineDx (elem, size, windowWidth) {
 ...
 // Get once in changePizzaSizes function
 // commented out -> var windowWidth = document.querySelector("#randomPizzas").offsetWidth;
